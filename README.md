...
## Environments
- Preview: https://main--sta-da-e2e--aemysites.aem.page/
- Live: https://main--sta-da-e2e--aemysites.aem.live/
- Block Library: https://main--sta-da-e2e--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `sta-da-e2e` directory in your favorite IDE and start coding :)
